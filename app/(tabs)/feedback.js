    ...
    <View style={{ flex: 1, }}>
      <View style={styles.head}>
        ...
        <View style={styles.search}>
          ...
          <Image
            source={require('./assets/images/publish8_12_images/search.png')}
      ...
      <ScrollView style={[styles.entire, { position: 'relative', }]}>
        ...
        <View style={[styles.contentBox, { position: 'relative' }]}>
          <Image
            source={require('./assets/images/publish8_12_images/bookmark.png')}
            style={{ width: 34, height: 34, marginLeft: 300, top: -17, zIndex: 10, position: 'absolute' }}
          />
...
//5
      ...
      <View style={styles.foot}>
        <TouchableOpacity style={styles.footBtn1L}>
          <Image
            source={require('./assets/images/publish8_12_images/Home.png')}
            style={{ width: 25, height: 35, }}
          />
        </TouchableOpacity>
        <TouchableOpacity style={styles.footBtn1}>
          <Image
            source={require('./assets/images/publish8_12_images/feedback.png')}
            style={{ width: 25, height: 35, }}
          />
        </TouchableOpacity>
        <TouchableOpacity style={styles.footBtn1}>
        ...
        <TouchableOpacity style={styles.footBtn1}>
          <Image
            source={require('./assets/images/publish8_12_images/cal.png')}
            style={{ width: 25, height: 35, }}
          />
        </TouchableOpacity>
        <TouchableOpacity style={styles.footBtn1R}>
          <Image
            source={require('./assets/images/publish8_12_images/myPage.png')}
