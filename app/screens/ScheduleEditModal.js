...
export default function ScheduleEditModal({
  ...
  const [hour, setHour] = useState(editingItem.hour);
  const [minute, setMinute] = useState(editingItem.minute);
  const [priority, setPriority] = useState(editingItem.priority);
  ...
  return (
    <Modalize
      ref={modalAddRef}
      modalHeight={SCREEN_HEIGHT * 0.66}
